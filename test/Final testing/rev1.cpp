...
int P2_count = 0;
int P2_steps = 3300; //set to start position
...
void ball_y_movement(){
    ...
    //add redirection code based on paddle hit
    //if lower corner is above top 3/4 of paddle -> redirect toward upperYlim
    //if upper corner is below 1/4 of paddle -> redirect toward lowerYlim
}
